...
export const translations = {
    cn: {
        ...
        'settings.vocabBook': '学习词库',
        'settings.vocabBookPlaceholder': '选择词库',
        'settings.vocabBookHint': '选择您要学习的词库，每天自动注入新单词',
        'settings.reviewLimit': '复习上限',
        'settings.words': '个单词',
        'settings.save': '保存更改',
        'settings.saving': '保存中...',
    },
    en: {
        ...
        'settings.vocabBook': 'Vocabulary Book',
        'settings.vocabBookPlaceholder': 'Select a vocabulary book',
        'settings.vocabBookHint': 'Choose your vocabulary book for daily automatic word injection',
        'settings.reviewLimit': 'Review Limit',
